...
from utils.advanced_indicators import (
    calculate_macd, detect_swing_highs_lows, is_comando_candle,
    is_force_candle, calculate_average_body, get_wick_stats
)
        ...
        if signal and self.ai_analyzer:
            try:
                ...
                zones = {
                    ...
                    "support": [{"level": l, "touches": 1} for l in recent_lows[-5:]]
                }
